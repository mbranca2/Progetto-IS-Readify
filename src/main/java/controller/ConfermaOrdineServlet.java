...
public class ConfermaOrdineServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!validaDatiPagamento(nomeTitolare, numeroCarta, scadenza, cvv)) {
            ...
            request.getRequestDispatcher("/jsp/pagamento.jsp").forward(request, response);
            return;
        }
        try {
            // Creo nuovo ordine
            ...
            if (salvato) {
                ...
                response.sendRedirect(request.getContextPath() +
                        "/jsp/conferma-ordine.jsp?id=" + ordine.getIdOrdine());
            } else {
    ...
    private boolean validaDatiPagamento(String nomeTitolare, String numeroCarta,
