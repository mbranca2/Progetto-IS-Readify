...
<head>
  ...
  <style>
    ...
    .btn { padding:6px 10px; border-radius:10px; border:1px solid #ddd; background:#f7f7f7; cursor:pointer; }
    .btn-danger { background:#fff3f3; border-color:#ffd4d4; }
    .muted { color:#666; }
    .badge { padding: 4px 8px; border-radius: 10px; background: #eee; font-size: 0.9em; }
    .comment { max-width: 520px; white-space: pre-wrap; }
  </style>
</head>
<body>
      ...
      <table>
        ...
        <c:choose>
          <c:when test="${empty reviews}">
            <tr><td colspan="7" class="muted">Nessuna recensione presente.</td></tr>
          </c:when>
          <c:otherwise>
