...
<head>
    ...
    <title>Pagamento - Librorama</title>
    <style>
        * {
        ...
        <div class="content">
            ...
            <div class="order-summary">
                    ...
                    <div class="order-item">
                        ...
                        <div class="order-item-info">
                            ...
                            <div class="order-item-price">
                                €<fmt:formatNumber value="${articolo.libro.prezzo * articolo.quantita}" minFractionDigits="2" maxFractionDigits="2"/>
                            </div>
                        </div>
                    </div>
                        </c:forEach>
                ...
                <div class="order-total">
                    Totale: €<fmt:formatNumber value="${not empty totale ? totale : 0}" minFractionDigits="2" maxFractionDigits="2"/>
                </div>
            </div>
        </div>
    </div>
