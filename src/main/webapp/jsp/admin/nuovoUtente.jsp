...
<main class="form-container">
    ...
    <form id="utenteForm" method="post" action="${pageContext.request.contextPath}/admin/utenti" class="form needs-validation" novalidate>
    ...
    <p>
        <a href="${pageContext.request.contextPath}/jsp/admin/gestione-utenti.jsp" class="btn btn-link">
